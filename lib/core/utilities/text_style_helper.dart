...
abstract class TextStyleHelper {
  ...
  static TextStyle get regular16 => TextStyle(
      fontSize: 16.sp,
      fontWeight: FontWeight.normal,
      color: CutsomColors.neutralColor500);
  ...
  static TextStyle get regular36 => TextStyle(
      ...
      fontWeight: FontWeight.normal,
      color: CutsomColors.neutralColor900);
  static TextStyle get regular72 => TextStyle(
      fontSize: 72.sp,
      fontWeight: FontWeight.normal,
      color: CutsomColors.neutralColor900);
  ...
  static TextStyle get medium36 => TextStyle(
      ...
      fontWeight: FontWeight.w500,
      color: CutsomColors.neutralColor900);
  static TextStyle get medium72 => TextStyle(
      fontSize: 72.sp,
      fontWeight: FontWeight.w500,
      color: CutsomColors.neutralColor900);
  ...
  static TextStyle get semiBold36 => TextStyle(
      ...
      fontWeight: FontWeight.w600,
      color: CutsomColors.neutralColor900);
  static TextStyle get semiBold72 => TextStyle(
      fontSize: 72.sp,
      fontWeight: FontWeight.w600,
      color: CutsomColors.neutralColor900);
  ...
  static TextStyle get bold36 => TextStyle(
      ...
      fontWeight: FontWeight.bold,
      color: CutsomColors.neutralColor900);
  static TextStyle get bold72 => TextStyle(
      fontSize: 72.sp,
      fontWeight: FontWeight.bold,
      color: CutsomColors.neutralColor900);
}
